...
public class TrackpadService {
        // Debugging
    private static final String TAG = "TrackpadService";
...
//    private int mConnectionLostCount;
     ...
     */
    public TrackpadService(Context context, Handler handler) {
    ...
    private class ConnectThread extends Thread {
        ...
        public void run() {
            ...
            try {
                ...
                TrackpadService.this.start();
                return;
            }

            // Reset the ConnectThread because we're done
            synchronized (TrackpadService.this) {
                mConnectThread = null;
            }
